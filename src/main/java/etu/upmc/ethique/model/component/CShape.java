...
public class CShape implements Comparable {
	...
	public enum Type {
		Track, Bridge, Switch, Group, Train, Circle
	}
	private Type type;
	...
	public ComponentTrolley getComponentTrolley() { return this.object; }

	public void setComponentTrolley(ComponentTrolley object) { this.object = object; }
